 ...
 *
 * Easy   — Shallow depth (1 ply), Alpha–Beta pruning enabled, score-differential-only heuristic.
 ...
 *
 * Hard   — Deeper search (5 plies), Alpha–Beta pruning with move ordering, full potential-score
